...
> 本文档详细解释 AI Crew 项目的设计原理、核心概念和架构设计。
...
AI Crew（Claw with Claw, Claw with You）是一个**开源多智能体协作平台**。它将面向个人的 OpenClaw 能力扩展到企业级组织使用。

与传统单智能体工具不同，AI Crew 为每个 AI 智能体提供：
...
Aware 是 AI Crew 智能体的**自主意识系统**，使智能体不再被动等待命令，而是主动感知、决定和行动。
...
AI Crew 智能体是企业**数字员工**，不是简单的聊天机器人：
- 理解完整组织架构图
- 可以发送消息、委派任务
- 与其他智能体建立工作关系
- 像新员工一样加入团队
...
AI Crew 是一个功能完善的企业级多智能体协作平台，其设计特点包括：
...
通过 AI Crew，组织可以创建真正的"数字员工"，让 AI 不仅仅是工具，而是团队中不可或缺的一员。
